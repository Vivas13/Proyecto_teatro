...
salida.innerHTML += `<br>Nombre ${familia_1.nombre}: Pago $${familia_1.Pago()}, Entrada $${familia_1.Entrada()}`
salida.innerHTML += `<br>Nombre ${familia_2.nombre}: Pago $${familia_2.Pago()}, Entrada $${familia_2.Entrada()}`
salida.innerHTML += `<br>Nombre ${familia_3.nombre}: Pago $${familia_3.Pago()}, Entrada $${familia_3.Entrada()}`
salida.innerHTML += `<br>Nombre ${familia_4.nombre}: Pago $${familia_4.Pago()}, Entrada $${familia_4.Entrada()}`
salida.innerHTML += `<br>Nombre ${familia_5.nombre}: Pago $${familia_5.Pago()}, Entrada $${familia_5.Entrada()}`
